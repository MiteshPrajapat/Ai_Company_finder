...
class Database:
    ...
    def init_schema(self):
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_resumes_default ON resumes(is_default);")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_applications_job ON applications(job_id);")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_applications_comp ON applications(company_id);")
